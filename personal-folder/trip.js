const trip = [
    {
        ...
        campers: 4,
        type: ["Tent camping", "RV camping", "Backcountry camping", "Cabin rentals"]
    },
    {
        name: "Teton Valley",
        stub: "teton-valley",
    ...
    },
    {
        ...
        description: "Bear Lake is a natural freshwater lake located on the Utah-Idaho border, known for its turquoise-blue water and recreational activities such as boating, fishing, and swimming.",
        availability: "Open year-round, with peak tourist season in summer.",
        campers: 6,
        type: ["Tent camping", "RV camping", "Cabin rentals"]
    }
]