...
form.addEventListener("submit", function (event) {
  ...
  if (type === "many" && !note) {
    output.textContent = "Please add a note travel note.";
    return;
  }
  
  //Let the user know if they choose many campus but only had one campus selected that they 
  // need to choose at least two campuses
